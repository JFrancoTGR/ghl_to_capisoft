<?php
// =======================================================
// CAPISoft -> GHL Terminal Status Sync (THE WAVVE) Cron Job
...
// WAVVE: CAPISoft etapa_id terminal -> GHL opportunity status
...
$logFile   = $logsDir . "/capisoft_terminal_status_wavve.log";
